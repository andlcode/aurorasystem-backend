...
router.get("/responsibles", (0, requireRole_1.requireRole)("evangelizador", "super_admin"), (0, asyncHandler_1.asyncHandler)(classesController.listResponsibles));
router.post("/", (0, requireRole_1.requireRole)("evangelizador", "super_admin"), (0, asyncHandler_1.asyncHandler)(classesController.createClass));
router.get("/", requireAuth_1.requireAuth, (0, asyncHandler_1.asyncHandler)(classesController.listClasses));
router.get("/:id/participants", requireAuth_1.requireAuth, (0, asyncHandler_1.asyncHandler)(classesController.listParticipants));
router.post("/:id/participants", (0, requireRole_1.requireRole)("super_admin"), (0, asyncHandler_1.asyncHandler)(classesController.addParticipant));
router.delete("/:id/participants/:participantId", (0, requireRole_1.requireRole)("super_admin"), (0, asyncHandler_1.asyncHandler)(classesController.removeParticipant));
